...
> [!NOTE]
> This project is designed to run on GNU/Linux, however you should be able to develop it on Windows and macOS.
...
- Clone this repo.
- Run `./scripts/setup.sh` To make a virtual python enviroment, build rust libraries, and install python dependencies.
